...
''';
  ...
  static const _id = "1qEOf10ebxcqhTtTcqeObYeFhU_pZqRxq-S4yF4vo7dQ";

  static final stickysheet = GSheets(_credential); //doc address
  ...
  static Future insert(String note ) async{
    ...
    currentNotes.add([
      note,
      0 //when writing a task it is obvious that it has not done yet
    ]);
  ...
  static Future loadNotes() async{
    ...
    for(int i =0 ; i< numberOfNotes ; i++){
      ...
      final int doneOrNO = int.parse(await _worksheet!.values.value(column: 2, row: i+1));
